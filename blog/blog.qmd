...
The naive model fails. The R^2^ of 9% collapses to 5% when using adjusted R^2^, reflecting that we explain little of the variation in daily average sentiment. No variables are statistically significant, including WTI values. Clearly, oil prices alone do not drive news sentiment, there is far greater depth.
